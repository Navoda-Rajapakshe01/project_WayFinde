...
{
    /// <inheritdoc />
    public partial class PostCommentReactTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfReads = table.Column<int>(type: "int", nullable: false),
                    NumberOfReacts = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    CoverImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageUrls = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Accommodations_PlacesToVisit_PlacesToVisitId",
                        column: x => x.PlacesToVisitId,
                        principalTable: "PlacesToVisit",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Accommodations_UsersNew_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Vehicles_UsersNew_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "UsersNew",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostComments_UsersNew_UserId",
                        column: x => x.UserId,
                        principalTable: "UsersNew",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostReactions_UsersNew_UserId",
                        column: x => x.UserId,
                        principalTable: "UsersNew",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accommodations_PlacesToVisitId",
                table: "Accommodations",
